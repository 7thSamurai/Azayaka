...
void Display::update(const Color *video_buffer, bool draw_text) {
...
void Display::resize(int w, int h, int num) {
    int width = display_width * ++num;

    if (lock_aspect_ratio) {
        float want_aspect = (float)width / (float)display_height;
